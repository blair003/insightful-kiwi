...
source("R/modules/predator_pressure.R")
source("R/modules/spatial_explorer.R")
...
source("R/functions/map_draw.R")     # shared DRAW tier (consumes spatial.R's ik_marker_radius)
...
source("R/functions/health.R")         # network-health strip (ik_health_strip + ik_trapping_health)
