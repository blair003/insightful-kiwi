...
server <- function(input, output, session) {
  ...
  mon_records_selection     <- selection_server("mon_records_selection",     ik_data, prefer_scientific, datasets = .rec_datasets)
  control_records_selection <- selection_server("control_records_selection", ik_data, prefer_scientific, datasets = .rec_datasets)
