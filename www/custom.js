...
//      });
      ...
      $(document).on('shiny:connected', function(event) {
        ...
        function shouldShareInput(id, nav) {
          ...
          if (nav === 'density_map') {
            return /^density_map_primary-(selected_species|selected_localities|exclude_possible_duplicates|show_density_location_markers|show_predicted_rai_surface|predicted_rai_surface_basis|trap_locality_distance_km|show_trap_capture_markers|show_trap_blank_checks|show_trap_unchecked_locations)$/.test(id) ||
