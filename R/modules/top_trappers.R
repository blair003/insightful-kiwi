...
top_trappers_ui <- function(id, ik_data) {
  ...
  nav_panel(
    ...
    div(class = "ik-tt",
        .ik_titlebar(
            tags$h3(class = "ik-tt-title", "Top trappers — season leaderboard"),
            .ik_info(ns("tt_help"), "Top trappers — how it works", top_trappers_help_body(w, lbl))),
        tags$p(class = "ik-tt-lead",
          "Who's checking the traps and catching the predators that matter — ranked for one completed ",
