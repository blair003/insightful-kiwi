...
reserve_report_ui <- function(id, ik_data) {
  ...
  nav_panel(
    ...
    div(class = "ik-rr",
        .ik_titlebar(
            tags$h3(class = "ik-rr-title", "Reserve report — the whole story over time"),
            .ik_info(ns("rr_help"), "Reserve report — how to read this", reserve_report_help_body())),
        tags$p(class = "ik-rr-lead",
          "One reserve, season by season, as a single chain: effort → servicing → catches → predators on ",
